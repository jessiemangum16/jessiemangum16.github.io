...
function sub(){
    ...
    let outputAdd = new Vec(x1, y1).minus(new Vec(x2, y2));
    let outputDistance1 = new Vec(x1, y1).length;
    let outputDistance2 = new Vec(x2, y2).length;

    document.getElementById("sub-div").innerText = "( " + outputAdd.x + ", " + outputAdd.y + " )";
    document.getElementById("distance-1").innerText = "Distance from origin: " + outputDistance1.toFixed(2);
    document.getElementById("distance-2").innerText = "Distance from origin: " + outputDistance2.toFixed(2);
}
